...
```
A comprehensive titorial is also [available](https://github.com/biobakery/banocc).
...
There are also ensemble approaches in which an edge is only considered if it was found significant in multiple methods.
